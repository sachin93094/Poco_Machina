...
// Disable POCO signal handler, so when a issue occurs
// the core dump will be at the source of the issue
// also can see if we have a SEGV, or ABRT
#define POCO_NO_SIGNAL_HANDLER

//Enable Thread Naming in POCO
//Available only for POSIX
#ifndef POCO_OS_FAMILY_WINDOWS
	#ifndef POCO_VXWORKS
		#define POCO_POSIX_DEBUGGER_THREAD_NAMES
	#endif
#endif
