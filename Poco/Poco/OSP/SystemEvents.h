...
public:
	enum EventKind
	{
		...
		EV_SYSTEM_READY_FOR_SUSPEND,
		EV_SYSTEM_APP_SHUTDOWN_COMPLETE
	};
	...
	Poco::BasicEvent<EventKind> customSystemEvent;
		/// Fired when all bundles are in NORMAL state(lifecycle state)
