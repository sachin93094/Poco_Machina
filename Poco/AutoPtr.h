...
/**
 * @namespace Poco Poco Version : 1.7.8p2 \n
 * Detailed Documentation at: https://pocoproject.org/releases/poco-1.7.8/  \n
 * From the link above, see poco-1.7.8-all-doc.zip
 */
namespace Poco {
...
public:
	...
	C* operator -> ()
	{
		if (_ptr)
			...
			std::abort(); //throw NullPointerException();
	}
